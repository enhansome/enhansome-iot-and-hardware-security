...
* [bettercap](https://github.com/bettercap/bettercap) ⭐ 19,793 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - bettercap is a powerful, easily extensible and portable framework written in Go which aims to offer to security researchers, red teamers and reverse engineers an easy to use, all-in-one solution with all the features they might possibly need for performing reconnaissance and attacking WiFi networks, Bluetooth Low Energy devices, wireless HID devices and Ethernet networks
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,229 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images
...
* [HAL - The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 816 | 🐛 18 | 🌐 C++ | 📅 2026-08-14 - HAL is a comprehensive netlist reverse engineering and manipulation framework
...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,713 | 🐛 25 | 🌐 C | 📅 2026-08-14 - AFL++ is a superior fork to Google's AFL - more speed, more and better mutations, more and better instrumentation, custom module support
...
* [Awesome Connected Things Security](https://github.com/V33RU/awesome-connected-things-sec) ⭐ 3,511 | 🐛 0 | 📅 2026-08-13 - A curated list of IoT and connected-things security resources
