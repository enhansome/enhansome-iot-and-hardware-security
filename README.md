...
* [JTAGulator](https://github.com/grandideastudio/jtagulator) ⭐ 801 | 🐛 3 | 🌐 Propeller Spin | 📅 2025-07-29 - An open-source hardware tool that helps identify JTAG and UART interfaces on unknown targets
...
* [Proxmark Platform](https://github.com/RfidResearchGroup/proxmark3) ⭐ 5,973 | 🐛 73 | 🌐 C | 📅 2026-08-20 - The Proxmark is an RFID swiss-army tool, allowing for both high and low level interactions with the vast majority of RFID tags and systems world-wide. Originally built by Jonathan Westhues over 10 years ago, the device has progressively evolved into the industry standard tool for RFID analysis
* [ChameleonUltra](https://github.com/RfidResearchGroup/ChameleonUltra) ⭐ 2,936 | 🐛 117 | 🌐 C | 📅 2026-08-10 - An open-source NFC emulation and research platform for low-frequency and high-frequency RFID work
...
* [bettercap](https://github.com/bettercap/bettercap) ⭐ 19,824 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - bettercap is a powerful, easily extensible and portable framework written in Go which aims to offer to security researchers, red teamers and reverse engineers an easy to use, all-in-one solution with all the features they might possibly need for performing reconnaissance and attacking WiFi networks, Bluetooth Low Energy devices, wireless HID devices and Ethernet networks
...
* [KillerBee](https://github.com/riverloopsec/killerbee) ⭐ 847 | 🐛 31 | 🌐 C | 📅 2023-09-12 - Framework and tools for sniffing, injecting, and auditing Zigbee and IEEE 802.15.4 networks
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,245 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images
* [RouterSploit](https://github.com/threat9/routersploit) ⭐ 13,217 | 🐛 93 | 🌐 Python | 📅 2026-05-05 - The RouterSploit Framework is an open-source exploitation framework dedicated to embedded devices
...
* [Unblob](https://github.com/onekey-sec/unblob) ⭐ 2,541 | 🐛 37 | 🌐 Python | 📅 2026-08-20 - Unblob is an accurate, fast, and easy-to-use extraction suite. It parses unknown binary blobs for more than 30 different archive, compression, and file-system formats, extracts their content recursively, and carves out unknown chunks that have not been accounted for
...
* [FirmWire](https://github.com/FirmWire/FirmWire) ⭐ 875 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - A full-system baseband firmware emulation platform for dynamic analysis of embedded and mobile firmware
* [HAL - The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 820 | 🐛 20 | 🌐 C++ | 📅 2026-08-21 - HAL is a comprehensive netlist reverse engineering and manipulation framework
...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,729 | 🐛 25 | 🌐 C | 📅 2026-08-21 - AFL++ is a superior fork to Google's AFL - more speed, more and better mutations, more and better instrumentation, custom module support
...
* [CHIPSEC](https://github.com/chipsec/chipsec) ⭐ 3,295 | 🐛 55 | 🌐 Python | 📅 2026-08-21 - A platform security assessment framework for analyzing the security of PC hardware, firmware, and low-level platform components
...
* [Awesome Connected Things Security](https://github.com/V33RU/awesome-connected-things-sec) ⭐ 3,518 | 🐛 0 | 📅 2026-08-18 - A curated list of IoT and connected-things security resources
* [Awesome Embedded and IoT Security](https://github.com/fkie-cad/awesome-embedded-and-iot-security) ⭐ 2,425 | 🐛 2 | 📅 2023-10-17
* [Awesome IoT Hacks](https://github.com/nebgnahz/awesome-iot-hacks) ⭐ 2,423 | 🐛 3 | 📅 2020-05-16
...
* [Awesome Embedded Linux](https://github.com/fkromer/awesome-embedded-linux) ⭐ 426 | 🐛 0 | 📅 2026-01-25
