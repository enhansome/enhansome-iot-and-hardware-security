...
* [Proxmark Platform](https://github.com/RfidResearchGroup/proxmark3) ⭐ 6,045 | 🐛 57 | 🌐 C | 📅 2026-09-10 - The Proxmark is an RFID swiss-army tool, allowing for both high and low level interactions with the vast majority of RFID tags and systems world-wide. Originally built by Jonathan Westhues over 10 years ago, the device has progressively evolved into the industry standard tool for RFID analysis
* [ChameleonUltra](https://github.com/RfidResearchGroup/ChameleonUltra) ⭐ 2,993 | 🐛 119 | 🌐 C | 📅 2026-09-10 - An open-source NFC emulation and research platform for low-frequency and high-frequency RFID work
...
* [bettercap](https://github.com/bettercap/bettercap) ⭐ 19,956 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - bettercap is a powerful, easily extensible and portable framework written in Go which aims to offer to security researchers, red teamers and reverse engineers an easy to use, all-in-one solution with all the features they might possibly need for performing reconnaissance and attacking WiFi networks, Bluetooth Low Energy devices, wireless HID devices and Ethernet networks
...
* [ChipSHOUTER-PicoEMP Kit](https://github.com/newaetech/chipshouter-picoemp) ⭐ 767 | 🐛 23 | 🌐 C | 📅 2024-08-28 - A lower-cost PicoEMP build for self-study and hobbyist EMFI research from the NewAE ecosystem
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,328 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images
...
* [FirmAE](https://github.com/pr0v3rbs/FirmAE) ⭐ 927 | 🐛 49 | 🌐 Python | 📅 2026-06-24 - A scalable firmware emulation framework that improves analysis coverage for Linux-based IoT firmware
...
* [HAL - The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 827 | 🐛 20 | 🌐 C++ | 📅 2026-09-10 - HAL is a comprehensive netlist reverse engineering and manipulation framework
...
* [CHIPSEC](https://github.com/chipsec/chipsec) ⭐ 3,299 | 🐛 51 | 🌐 Python | 📅 2026-09-10 - A platform security assessment framework for analyzing the security of PC hardware, firmware, and low-level platform components
...
* [The Hacker's Hardware Toolkit: The best collection of hardware gadgets for red team hackers, pentesters and security researchers](https://github.com/yadox666/The-Hackers-Hardware-Toolkit/blob/master/TheHackersHardwareToolkit.pdf) ⭐ 2,177 | 🐛 5 | 📅 2020-09-07 - 2020, Publisher: N/A, Author(s): Yago Hansen
...
* [Awesome Connected Things Security](https://github.com/V33RU/awesome-connected-things-sec) ⭐ 3,533 | 🐛 1 | 📅 2026-08-29 - A curated list of IoT and connected-things security resources
