...
* [bettercap](https://github.com/bettercap/bettercap) ⭐ 19,871 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - bettercap is a powerful, easily extensible and portable framework written in Go which aims to offer to security researchers, red teamers and reverse engineers an easy to use, all-in-one solution with all the features they might possibly need for performing reconnaissance and attacking WiFi networks, Bluetooth Low Energy devices, wireless HID devices and Ethernet networks
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,283 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images
* [RouterSploit](https://github.com/threat9/routersploit) ⭐ 13,224 | 🐛 97 | 🌐 Python | 📅 2026-05-05 - The RouterSploit Framework is an open-source exploitation framework dedicated to embedded devices
...
* [Unblob](https://github.com/onekey-sec/unblob) ⭐ 2,544 | 🐛 35 | 📅 2026-08-28 - Unblob is an accurate, fast, and easy-to-use extraction suite. It parses unknown binary blobs for more than 30 different archive, compression, and file-system formats, extracts their content recursively, and carves out unknown chunks that have not been accounted for
...
* [HAL - The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 821 | 🐛 20 | 🌐 C++ | 📅 2026-08-28 - HAL is a comprehensive netlist reverse engineering and manipulation framework
...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,735 | 🐛 22 | 🌐 C | 📅 2026-08-28 - AFL++ is a superior fork to Google's AFL - more speed, more and better mutations, more and better instrumentation, custom module support
