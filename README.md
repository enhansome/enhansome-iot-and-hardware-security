...
Thanks to all [contributors](https://github.com/kayranfatih/awesome-iot-and-hardware-security/graphs/contributors) ⭐ 62 | 🐛 0 | 📅 2026-03-08. The goal is to build community-driven collection of  well-known resources.
...
* [JTAGulator](https://github.com/grandideastudio/jtagulator) ⭐ 804 | 🐛 3 | 🌐 Propeller Spin | 📅 2026-09-02 - An open-source hardware tool that helps identify JTAG and UART interfaces on unknown targets
...
* [Proxmark Platform](https://github.com/RfidResearchGroup/proxmark3) ⭐ 6,022 | 🐛 73 | 🌐 C | 📅 2026-09-05 - The Proxmark is an RFID swiss-army tool, allowing for both high and low level interactions with the vast majority of RFID tags and systems world-wide. Originally built by Jonathan Westhues over 10 years ago, the device has progressively evolved into the industry standard tool for RFID analysis
* [ChameleonUltra](https://github.com/RfidResearchGroup/ChameleonUltra) ⭐ 2,976 | 🐛 118 | 🌐 C | 📅 2026-08-10 - An open-source NFC emulation and research platform for low-frequency and high-frequency RFID work
...
* [bettercap](https://github.com/bettercap/bettercap) ⭐ 19,932 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - bettercap is a powerful, easily extensible and portable framework written in Go which aims to offer to security researchers, red teamers and reverse engineers an easy to use, all-in-one solution with all the features they might possibly need for performing reconnaissance and attacking WiFi networks, Bluetooth Low Energy devices, wireless HID devices and Ethernet networks
...
* [Sniffle](https://github.com/nccgroup/Sniffle) ⭐ 1,167 | 🐛 31 | 🌐 Python | 📅 2025-09-25 - A sniffer for Bluetooth 5 and 4.x (LE) using TI CC1352/CC26x2 hardware
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,312 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images
* [RouterSploit](https://github.com/threat9/routersploit) ⭐ 13,235 | 🐛 97 | 🌐 Python | 📅 2026-05-05 - The RouterSploit Framework is an open-source exploitation framework dedicated to embedded devices
* [EMBA The security analyzer for firmware of embedded devices](https://github.com/e-m-b-a/emba) ⭐ 3,644 | 🐛 15 | 🌐 Shell | 📅 2026-09-04 - EMBA is designed as the central firmware analysis tool for penetration testers and product security teams. It supports the complete security analysis process starting with firmware extraction, doing static analysis and dynamic analysis via emulation and finally generating a web report
* [Unblob](https://github.com/onekey-sec/unblob) ⭐ 2,548 | 🐛 39 | 📅 2026-09-04 - Unblob is an accurate, fast, and easy-to-use extraction suite. It parses unknown binary blobs for more than 30 different archive, compression, and file-system formats, extracts their content recursively, and carves out unknown chunks that have not been accounted for
...
* [FirmAE](https://github.com/pr0v3rbs/FirmAE) ⭐ 921 | 🐛 49 | 🌐 Python | 📅 2026-06-24 - A scalable firmware emulation framework that improves analysis coverage for Linux-based IoT firmware
* [FirmWire](https://github.com/FirmWire/FirmWire) ⭐ 880 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - A full-system baseband firmware emulation platform for dynamic analysis of embedded and mobile firmware
* [HAL - The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 827 | 🐛 20 | 🌐 C++ | 📅 2026-09-01 - HAL is a comprehensive netlist reverse engineering and manipulation framework
...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,746 | 🐛 22 | 🌐 C | 📅 2026-09-04 - AFL++ is a superior fork to Google's AFL - more speed, more and better mutations, more and better instrumentation, custom module support
...
* [CHIPSEC](https://github.com/chipsec/chipsec) ⭐ 3,299 | 🐛 50 | 🌐 Python | 📅 2026-09-02 - A platform security assessment framework for analyzing the security of PC hardware, firmware, and low-level platform components
...
* [IoTGoat](https://github.com/OWASP/IoTGoat) ⭐ 930 | 🐛 2 | 🌐 C | 📅 2025-10-05 - A deliberately insecure OpenWrt-based firmware for learning and practicing IoT security testing
...
* [Awesome Connected Things Security](https://github.com/V33RU/awesome-connected-things-sec) ⭐ 3,531 | 🐛 0 | 📅 2026-08-29 - A curated list of IoT and connected-things security resources
