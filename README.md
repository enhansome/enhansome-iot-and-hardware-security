...
* [Proxmark Platform](https://github.com/RfidResearchGroup/proxmark3) ⭐ 6,100 | 🐛 46 | 🌐 C | 📅 2026-09-25 - The Proxmark is an RFID swiss-army tool, allowing for both high and low level interactions with the vast majority of RFID tags and systems world-wide. Originally built by Jonathan Westhues over 10 years ago, the device has progressively evolved into the industry standard tool for RFID analysis
* [ChameleonUltra](https://github.com/RfidResearchGroup/ChameleonUltra) ⭐ 3,038 | 🐛 120 | 🌐 C | 📅 2026-09-11 - An open-source NFC emulation and research platform for low-frequency and high-frequency RFID work
...
* [bettercap](https://github.com/bettercap/bettercap) ⭐ 20,027 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - bettercap is a powerful, easily extensible and portable framework written in Go which aims to offer to security researchers, red teamers and reverse engineers an easy to use, all-in-one solution with all the features they might possibly need for performing reconnaissance and attacking WiFi networks, Bluetooth Low Energy devices, wireless HID devices and Ethernet networks
...
* [Sniffle](https://github.com/nccgroup/Sniffle) ⭐ 1,178 | 🐛 31 | 🌐 Python | 📅 2025-09-25 - A sniffer for Bluetooth 5 and 4.x (LE) using TI CC1352/CC26x2 hardware
...
* [ChipSHOUTER-PicoEMP Kit](https://github.com/newaetech/chipshouter-picoemp) ⭐ 774 | 🐛 23 | 🌐 C | 📅 2024-08-28 - A lower-cost PicoEMP build for self-study and hobbyist EMFI research from the NewAE ecosystem
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,371 | 🐛 96 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images
* [RouterSploit](https://github.com/threat9/routersploit) ⭐ 13,248 | 🐛 97 | 🌐 Python | 📅 2026-05-05 - The RouterSploit Framework is an open-source exploitation framework dedicated to embedded devices
* [EMBA The security analyzer for firmware of embedded devices](https://github.com/e-m-b-a/emba) ⭐ 3,679 | 🐛 14 | 🌐 Shell | 📅 2026-09-24 - EMBA is designed as the central firmware analysis tool for penetration testers and product security teams. It supports the complete security analysis process starting with firmware extraction, doing static analysis and dynamic analysis via emulation and finally generating a web report
* [Unblob](https://github.com/onekey-sec/unblob) ⭐ 2,560 | 🐛 38 | 🌐 Python | 📅 2026-09-24 - Unblob is an accurate, fast, and easy-to-use extraction suite. It parses unknown binary blobs for more than 30 different archive, compression, and file-system formats, extracts their content recursively, and carves out unknown chunks that have not been accounted for
...
* [FirmAE](https://github.com/pr0v3rbs/FirmAE) ⭐ 939 | 🐛 49 | 🌐 Python | 📅 2026-06-24 - A scalable firmware emulation framework that improves analysis coverage for Linux-based IoT firmware
...
* [HAL - The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 830 | 🐛 19 | 🌐 C++ | 📅 2026-09-25 - HAL is a comprehensive netlist reverse engineering and manipulation framework
...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,771 | 🐛 22 | 🌐 C | 📅 2026-09-21 - AFL++ is a superior fork to Google's AFL - more speed, more and better mutations, more and better instrumentation, custom module support
* [Boofuzz: Network Protocol Fuzzing for Humans](https://github.com/jtpereyda/boofuzz) ⭐ 2,361 | 🐛 101 | 🌐 Python | 📅 2026-09-21 - Boofuzz is a fork of and the successor to the venerable Sulley fuzzing framework. Besides numerous bug fixes, boofuzz aims for extensibility

### Misc Tools

* [CHIPSEC](https://github.com/chipsec/chipsec) ⭐ 3,306 | 🐛 40 | 🌐 Python | 📅 2026-09-24 - A platform security assessment framework for analyzing the security of PC hardware, firmware, and low-level platform components
* [Flashrom](https://github.com/flashrom/flashrom) ⭐ 1,174 | 🐛 80 | 🌐 C | 📅 2026-09-26 - Flashrom is a utility for detecting, reading, writing, verifying and erasing flash chips. It is often used to flash BIOS/EFI/coreboot/firmware images in-system using a supported mainboard, but it also supports flashing of network cards (NICs), SATA controller cards, and other external devices which can program flash chips
...
* [EMUX](https://github.com/therealsaumil/emux) ⭐ 875 | 🐛 12 | 🌐 Python | 📅 2025-08-22 - An embedded device emulation framework that is useful for building reproducible firmware-analysis labs
...
* [Awesome Connected Things Security](https://github.com/V33RU/awesome-connected-things-sec) ⭐ 3,545 | 🐛 2 | 📅 2026-08-29 - A curated list of IoT and connected-things security resources
