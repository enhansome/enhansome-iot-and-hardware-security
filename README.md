...
* [Proxmark Platform](https://github.com/RfidResearchGroup/proxmark3) ⭐ 6,048 | 🐛 57 | 🌐 C | 📅 2026-09-12 - The Proxmark is an RFID swiss-army tool, allowing for both high and low level interactions with the vast majority of RFID tags and systems world-wide. Originally built by Jonathan Westhues over 10 years ago, the device has progressively evolved into the industry standard tool for RFID analysis
* [ChameleonUltra](https://github.com/RfidResearchGroup/ChameleonUltra) ⭐ 3,001 | 🐛 111 | 🌐 C | 📅 2026-09-11 - An open-source NFC emulation and research platform for low-frequency and high-frequency RFID work
...
* [bettercap](https://github.com/bettercap/bettercap) ⭐ 19,969 | 🐛 44 | 🌐 Go | 📅 2026-08-13 - bettercap is a powerful, easily extensible and portable framework written in Go which aims to offer to security researchers, red teamers and reverse engineers an easy to use, all-in-one solution with all the features they might possibly need for performing reconnaissance and attacking WiFi networks, Bluetooth Low Energy devices, wireless HID devices and Ethernet networks
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,333 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images
...
* [FirmAE](https://github.com/pr0v3rbs/FirmAE) ⭐ 928 | 🐛 49 | 🌐 Python | 📅 2026-06-24 - A scalable firmware emulation framework that improves analysis coverage for Linux-based IoT firmware
* [FirmWire](https://github.com/FirmWire/FirmWire) ⭐ 882 | 🐛 17 | 🌐 Python | 📅 2026-08-20 - A full-system baseband firmware emulation platform for dynamic analysis of embedded and mobile firmware
* [HAL - The Hardware Analyzer](https://github.com/emsec/hal) ⭐ 827 | 🐛 18 | 🌐 C++ | 📅 2026-09-11 - HAL is a comprehensive netlist reverse engineering and manipulation framework
...
* [CHIPSEC](https://github.com/chipsec/chipsec) ⭐ 3,298 | 🐛 49 | 🌐 Python | 📅 2026-09-12 - A platform security assessment framework for analyzing the security of PC hardware, firmware, and low-level platform components
...
* [Awesome Connected Things Security](https://github.com/V33RU/awesome-connected-things-sec) ⭐ 3,535 | 🐛 1 | 📅 2026-08-29 - A curated list of IoT and connected-things security resources
